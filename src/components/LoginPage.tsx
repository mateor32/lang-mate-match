...
const LoginPage = ({ onLogin }: LoginPageProps) => {
  ...
  // Usamos el hook useGoogleLogin, pero como un componente personalizado,
  // recurrimos al truco de 'render' que requiere omitir la verificación estricta.
  return (
      ...
      <Card className="w-full max-w-md p-8 shadow-elevated">
        <div className="text-center space-y-6">
          ...
          <GoogleLogin
            ...
            onError={handleError}
            {...({
              // <--- CLAVE: El truco para omitir la verificación de tipos
